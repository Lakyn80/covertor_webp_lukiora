    ...
    (
      ...
      >
        ...
        >
          ...
          <img src={logoUrl} width={164} height={164} alt="Lukiora logo" />
        </div>

        <div style={{ textAlign: "center", maxWidth: "860px" }}>
          <div style={{ fontSize: "48px", fontWeight: 700, lineHeight: 1.1 }}>{title}</div>
          <div style={{ fontSize: "22px", color: "#cbd5f5", marginTop: "12px" }}>{description}</div>
        </div>

        <div style={{ fontSize: "20px", color: "#94a3b8" }}>{siteHost}</div>
      </div>
    ),
    {
      width: size.width,
